...
const Contact = () => {
  return (
    <div className='flex items-center justify-center flex-col p-12 md:p-28'>
      ...
      <h1 className='relative font-bold text-4xl md:text-5xl text-center'>
        ...
        <span className='absolute inset-x-0 mx-auto w-20 border-b-8 border-black top-14 md:top-20 '></span>
      </h1>
      ...
      <div className='flex flex-col md:flex-row justify-center items-center gap-16 md:gap-20 mt-16 md:mt-24'>
        ...
        <div className='flex flex-col items-center text-center space-y-2 mt-10 md:mt-0'>
          ...
          <p className='text-gray-600 text-[16px] md:text-[18px] font-light'>SHOW ROOM</p>
