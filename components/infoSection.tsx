...
const InfoSection = () => {
  return (
    ...
    <div className='w-1/2 pt-10 space-y-8 md:space-y-4 pl-28 md:pl-20'>
        ...
        <p className='max-w-[700px] md:max-w-[800px]'>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris
        </p>
                <button className="relative px-16 md:px-10 py-5 md:py-4 border-1 uppercase bg-black text-white group  mt-6 ">
                    VIEW DETAILS
    ...
    <div className='w-1/2 pt-10 space-y-8 md:space-y-4 pl-28 md:pl-20'>
        ...
        <p className='max-w-[700px]'>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris
                ...
                <button className="relative px-16  md:px-10 md:py-4 py-5 border-1 uppercase bg-black text-white group  mt-6">
